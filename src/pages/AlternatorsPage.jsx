    ...
    <div className="min-h-screen bg-black font-sans text-white overflow-x-hidden selection:bg-[#ff8a4a]/30 selection:text-white">
      ...
      <main className="pt-32 pb-24 px-5 md:px-10 lg:px-14 max-w-[1400px] mx-auto">
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Alternator Installation Overview</h3>
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Alternator Diagnosis Steps</h3>
                ...
                <div className="space-y-4">
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Turn the ignition on but do not start the engine and observe the instrument cluster for warning lights</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Battery light illuminated key-on-engine-off (KOEO), does this turn off after the engine is started?</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Unusual noise coming from the alternator?</li>
                  </ul></div>
                  ...
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Connect scan tool and scan all modules for related diagnostic trouble codes (DTC)</div><ul>
                    ...
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Retest charging system to determine if fault has been corrected</li>
                  </ul></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Check belt condition, tension, and alignment</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Operate tensioner through full range of travel</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Check/replace belt</li>
                  </ul></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Inspect alternator wiring connections for damage and repair as needed</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Proceed if it is determined the alternator has failed and needs replacement</div></div>
                </div>
        </div>
        </div>
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Alternator Installation Steps</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Ensure alternator mounting surface is clean and free from debris, oil, grease, corrosion, etc.</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Transfer any mounting hardware, brackets, braces, spacers, sensors, switches from original alternator to replacement if applicable</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Torque alternator mounting bolts to proper specifications</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Verify connector compatibility</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">If connectors are different from OE, verify wire functions</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Follow included adaptor harness instructions (if applicable)</li>
                  </ul></div>
                  ...
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Properly torque all mounting bolts & electrical connections</div><ul>
                    ...
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Check belt alignment and tension</li>
                  </ul></div>
                </div>
        </div>
        </div>
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Alternator Verification</h3>
                
                <div className="space-y-4">
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Verify proper operation of charging system</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Allow engine to reach operating temperature</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Turn on accessories and monitor output in response to measure voltage and amperage output from alternator</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Compare to vehicle service information</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Verify charging system output voltage (13.5V-14.5V at idle)</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Test at various RPM levels</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Check for any warning lights or system codes</li>
                  </ul></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Road test vehicle with electrical loads active</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Turn on headlights, HVAC system, radio, etc.</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Verify stable charging system operation</li>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Verify correct function and operation</li>
                  </ul></div>
                </div>
        </div>
        </div>
