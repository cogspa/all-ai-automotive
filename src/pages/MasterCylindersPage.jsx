    ...
    <div className="min-h-screen bg-black font-sans text-white overflow-x-hidden selection:bg-[#ff8a4a]/30 selection:text-white">
      ...
      <main className="pt-32 pb-24 px-5 md:px-10 lg:px-14 max-w-[1400px] mx-auto">
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Master Cylinder Installation Overview</h3>
          ...
          <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Refer to vehicle service information for any special testing, removal, or installation procedures</div><ul>
                    ...
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Refer to any warning tags or technical bulletins included in the box with the replacement master cylinder</li>
                  </ul></div>
                  ...
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Obtain all vehicle information to ensure correct part application</div><ul>
                    <li className="text-[14px] text-white/60 ml-4 list-disc mb-1">Make, year, model, engine, drivetrain configuration (FWD, RWD, 4WD, AWD), brake system details, transmission type, etc.</li>
                  </ul></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">A complete inspection of the tires, steering, suspension, and brake system components for wear or damage should be performed</div></div>
                </div>
        </div>
        </div>
        ...
        <div className="rounded-3xl p-8 h-full break-inside-avoid mb-6" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="mb-8">
                <h3 className="font-display text-[24px] mb-4 text-white">Installation Steps</h3>
                
                <div className="space-y-4">
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">After bench bleeding the master cylinder, mount it on the vehicle using a new gasket/seal (if applicable), and torque mounting fasteners to the vehicle manufacturer's specifications</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Carefully start by hand-tightening all threaded brake line connections to avoid cross-threading and damage to replacement master cylinder or brake lines. Torque brake line connections to the vehicle manufacturer specifications</div></div>
                  
                  <div className="mb-4 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}><div className="font-display text-[16px] text-white mb-2">Fill master cylinder fluid reservoir to the proper level. Pump the brake pedal 3 – 4 times. Apply and hold brake pedal pressure while checking master cylinder brake line connections for leaks</div></div>
                </div>
        </div>
        </div>
